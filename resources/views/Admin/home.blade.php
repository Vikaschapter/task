                                        ...
                                        <tbody>
                                            ...
                                            @foreach($data as $d)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button class="btn btn-success" href="" type="submit"><a href="{{route('admin.image.edit',$d1->user_id)}}">Edit</a></button>
                                                        <form action="{{route('admin.image.delete',$d1->user_id)}}" method="POST">
                                                            @csrf
                                                            @method('delete')
